...
def test_purchase_bid_gas(
    ...
    with test_utils.GasWatcher(
        ...
        mkr_dai_pool.addQuoteToken(
            lender, 3_000 * 10**45, bucket_math.indexToPrice(1606), {"from": lender}
        )
        mkr_dai_pool.addQuoteToken(
            lender, 3_000 * 10**45, bucket_math.indexToPrice(1524), {"from": lender}
        )
        ...
        tx = mkr_dai_pool.purchaseBid(
            2_000 * 10**45, bucket_math.indexToPrice(1663), {"from": bidder}
        )
