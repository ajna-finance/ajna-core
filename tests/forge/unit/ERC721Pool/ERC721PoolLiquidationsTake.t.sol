...
contract ERC721PoolLiquidationsTakeTest is ERC721HelperContract {
    ...
    function testTakeCollateralSubsetPool() external tearDown {
        ...
        _take({
            ...
            collateralTaken: 1.479341819309844705 * 1e18, // not a rounded collateral, difference of 2 - 1.47 collateral should go to borrower in quote tokens at auction price
            isReward:        false
        });
