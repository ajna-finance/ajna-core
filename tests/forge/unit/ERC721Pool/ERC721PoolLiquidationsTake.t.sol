...
contract ERC721PoolLiquidationsTakeTest is ERC721HelperContract {
    ...
    function testTakeCollateralSubsetPool() external tearDown {
        ...
        _take({
            ...
            borrower:        _borrower,
            maxCollateral:   1,
            bondChange:      0.161203287030338712 * 1e18,
        ...
        _assertAuction(
            AuctionParams({
                ...
                active:            true,
                kicker:            _lender,
                bondSize:          0.082644260707135316 * 1e18,
                bondFactor:        0.011180339887498948 * 1e18,
                kickTime:          block.timestamp - 5.5 hours,
                referencePrice:    12.124431596439710011 * 1e18,
    ...
    function testTakeCollateralAndSettleSubsetPool() external tearDown {
        ...
        _take({
            ...
            borrower:        _borrower,
            maxCollateral:   2,
            bondChange:      0.067777633095463719 * 1e18,
        ...
        _assertAuction(
            AuctionParams({
                ...
                active:            true,
                kicker:            _lender,
                bondSize:          0.311625180832937747 * 1e18,
                bondFactor:        0.011180339887498948 * 1e18,
                kickTime:          block.timestamp - 10 hours,
                referencePrice:    12.124431596439710011 * 1e18, 
        ...
        _assertKicker({
            kicker:    _lender,
            claimable: 0,
            locked:    0.311625180832937747 * 1e18
        });
        ...
        _assertKicker({
            kicker:    _lender,
            claimable: 0.311625180832937747 * 1e18,
            locked:    0
        });
        ...
        assertEq(_quote.balanceOf(_lender), 46_993.905561834875608711 * 1e18);
    }
    ...
    function testTakeCollateralSubsetPoolAndSettleWithDebt() external tearDown {
        ...
        _take({
            ...
            borrower:        _borrower,
            maxCollateral:   1,
            bondChange:      0.000000000000123287 * 1e18,
        ...
        _assertAuction(
            AuctionParams({
                ...
                active:            true,
                kicker:            _lender,
                bondSize:          0.243847547737597315 * 1e18,
                bondFactor:        0.011180339887498948 * 1e18,
