    ...
    function testDepositTakeNFTAndSettleAuction() external {
        ...
        _assertAuction(
            AuctionParams({
                ...
                thresholdPrice:    11.506709959118993145 * 1e18,
        ...
        _assertBorrower({
            borrower:                  _borrower,
            borrowerDebt:              23.013419918237986290 * 1e18,
            borrowerCollateral:        2 * 1e18,
            borrowert0Np:              10.404995192307692312 * 1e18,
        ...
        _assertAuction(
            AuctionParams({
                ...
                auctionPrice:      0,
                debtInAuction:     0,
                thresholdPrice:    9.624359312514645335 * 1e18,
                neutralPrice:      0
            })
        );
        ...
        _assertBorrower({
            borrower:                  _borrower,
            borrowerDebt:              9.624359312514645335 * 1e18,
            borrowerCollateral:        1 * 1e18,
            borrowert0Np:              8.769696613728507382 * 1e18,
