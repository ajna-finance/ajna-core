...
contract ERC721PoolLiquidationsSettleAuctionTest is ERC721HelperContract {
    ...
    function testSettlePartialDebtSubsetPool() external tearDown {
        ...
        _addLiquidity({
            ...
            lpAward: 99.999999999452490779 * 1e18,
            newLup:  MAX_PRICE
        });
        ...
        _assertBucket({
            index:        2500,
            lpBalance:    14_853.871786224081499808 * 1e18,
            collateral:   0,
            deposit:      14_859.717685886623581004 * 1e18,
            exchangeRate: 1.000393560665305038 * 1e18
        });
        _assertBucket({
            index:        MAX_FENWICK_INDEX,
            lpBalance:    99.999999999452490779 * 1e18,
            collateral:   0,
            deposit:      100 * 1e18,
    ...
    function testDepositTakeAndSettleSubsetPool() external tearDown {
        ...
        _assertBucket({
            index:        MAX_FENWICK_INDEX,
            lpBalance:    4133739265,
            collateral:   0.041405180020601444 * 1e18,
            deposit:      0,
            exchangeRate: 1.000000000241911726 * 1e18
        });
        _assertBorrower({
            borrower:                  _borrower,
            borrowerDebt:              0,
        ...
        _addLiquidityWithPenalty({
            ...
            index:       MAX_FENWICK_INDEX,
            lpAward:     99.986438340487200042 * 1e18,
    ...
    function testDepositTakeAndSettleByPledgeSubsetPool() external tearDown {
        ...
        _assertBucket({
            index:        6113,
            lpBalance:    0.000008769784221044 * 1e18,
            collateral:   0.152044867770467010 * 1e18,
            deposit:      0,
            exchangeRate: 1.000000000000114028 * 1e18
        });
        ...
        _addLiquidityWithPenalty({
            ...
            index:       6113,
            lpAward:     999.876712328706864406 * 1e18,
            newLup:      3_844.432207828138682757 * 1e18
        });
        uint256[] memory removalIndexes = new uint256[](2);
        removalIndexes[0] = 2500;
        ...
        _removeAllLiquidity({
            ...
            index:    6113,
            newLup:   MAX_PRICE,
            lpRedeem: 0.000008769784221044 * 1e18
        });
    ...
    function testDepositTakeAndSettleByRepaySubsetPool() external tearDown {
        ...
        _addLiquidity({
            ...
            amount:  1000 * 1e18,
            index:   6113,
            lpAward: 999.999999999939733976 * 1e18,
            newLup:  MAX_PRICE
        });
        uint256[] memory removalIndexes = new uint256[](2);
        removalIndexes[0] = 2500;
    ...
    function testDepositTakeAndSettleByBucketTakeSubsetPool() external tearDown {
        ...
        _assertBucket({
            index:        6113,
            lpBalance:    0.000027941032210121 * 1e18,
            collateral:   0.484423611879052305 * 1e18,
            deposit:      0,
            exchangeRate: 1.000000000000035790 * 1e18
        });
        ...
        _addLiquidity({
            ...
            amount:  1_000 * 1e18,
            index:   6113,
            lpAward: 999.999999999975357341 * 1e18,
            newLup:  MAX_PRICE
        });
        uint256[] memory removalIndexes = new uint256[](3);
        ...
        _removeAllLiquidity({
            ...
            index:    6113,
            newLup:   MAX_PRICE,
            lpRedeem: 0.000027941032210121 * 1e18
        });
    }
    ...
    function testDepositTakeAndSettleBySettleSubsetPool() external tearDown {
        ...
        _assertBucket({
            index:        7388,
            lpBalance:    0.000000036616202578 * 1e18,
            collateral:   0.366762478717277852 * 1e18,
            deposit:      0,
            exchangeRate: 1.000000000027310314 * 1e18
        });
        ...
        _addLiquidity({
            ...
            amount:  1_000 * 1e18,
            index:   7388,
            lpAward: 999.999999982091098562 * 1e18,
            newLup:  MAX_PRICE
        });
        uint256[] memory removalIndexes = new uint256[](3);
        removalIndexes[0] = 2500;
