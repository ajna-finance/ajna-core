...
contract ERC721PoolLiquidationsSettleAuctionTest is ERC721HelperContract {
    ...
    function testSettlePartialDebtSubsetPool() external tearDown {
        ...
        _settle({
            ...
            borrower:    _borrower,
            maxDepth:    1,
            settledDebt: 1_369.798135353646461183 * 1e18
        });
        ...
        _assertBorrower({
            borrower:                  _borrower,
            borrowerDebt:              2_312.679171146173643004 * 1e18,
        ...
        _settle({
            ...
            borrower:    _borrower,
            maxDepth:    5,
            settledDebt: 1_149.439286743640491538 * 1e18
        });
        ...
        _assertBucket({
            ...
            deposit:      18_166.328630269137590935 * 1e18,
            exchangeRate: 1.546572469237995392 * 1e18
        });
        _assertBucket({
            index:        2499,
            lpBalance:    5_000 * 1e18,
        ...
        _assertBucket({
            index:        2500,
            lpBalance:    15_758.963593627333956365 * 1e18,
    ...
    function testDepositTakeAndSettleSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      9_560.263456841394679116 * 1e18,
            exchangeRate: 1.350226367184088258 * 1e18
        });
        _assertBucket({
            index:        2502,
            lpBalance:    3_863.757250427550337858 * 1e18,
