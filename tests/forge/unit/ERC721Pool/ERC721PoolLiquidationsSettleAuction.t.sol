...
contract ERC721PoolLiquidationsSettleAuctionTest is ERC721HelperContract {
    ...
    function testSettlePartialDebtSubsetPool() external tearDown {
        ...
        _assertBucket({
            index:        2500,
            lpBalance:    14_853.871786224081500202 * 1e18,
            collateral:   0,
            deposit:      14_859.717685886623581004 * 1e18,
            exchangeRate: 1.000393560665305037 * 1e18
        });
    ...
    function testDepositTakeAndSettleSubsetPool() external tearDown {
        ...
        _assertBucket({
            index:        2500,
            lpBalance:    7_138.736263736263736047 * 1e18,
            collateral:   1.847955132229532990 * 1e18,
            deposit:      0,
            exchangeRate: 1.000157402701482376 * 1e18
        });
        _assertBorrower({
            borrower:                  _borrower,
        ...
        _assertBucket({
            ...
            deposit:      0,
            exchangeRate: 0.999999999924641981 * 1e18
        });
        _assertBorrower({
            borrower:                  _borrower,
            borrowerDebt:              0,
    ...
    function testDepositTakeAndSettleByPledgeSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      0,
            exchangeRate: 0.999999999999946238 * 1e18
        });
    ...
    function testDepositTakeAndSettleByRegularTakeSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      0,
            exchangeRate: 0.999999999999999990 * 1e18
        });
        _assertBorrower({
            borrower:                  _borrower,
    ...
    function testDepositTakeAndSettleByBucketTakeSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      0,
            exchangeRate: 0.999999999999988852 * 1e18
        });
    ...
    function testDepositTakeAndSettleBySettleSubsetPool() external {
        ...
        _assertBucket({
            ...
            deposit:      1_574.490070004654380295 * 1e18,
            exchangeRate: 1.000336486815856336 * 1e18
        });
        _assertBucket({
            index:        2502,
            lpBalance:    2_857.142857142857142798 * 1e18,
        ...
        _assertBucket({
            ...
            deposit:      0,
            exchangeRate: 0.999999999989059502 * 1e18
        });
