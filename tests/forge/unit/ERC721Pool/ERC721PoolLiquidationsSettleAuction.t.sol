...
contract ERC721PoolLiquidationsSettleAuctionTest is ERC721HelperContract {
    ...
    function testSettlePartialDebtSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      19_929.399869278691733311 * 1e18,
            exchangeRate: 1.000393560665305039 * 1e18
        });
        _assertBorrower({
            borrower:                  _borrower,
        ...
        _assertBucket({
            ...
            deposit:      14_859.717685886623581002 * 1e18,
            exchangeRate: 1.000393560665305039 * 1e18
        });
        _assertBucket({
            index:        7388,
    ...
    function testDepositTakeAndSettleSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            exchangeRate: 1.000471394253082552 * 1e18
        });
        _assertBucket({
            index:        MAX_FENWICK_INDEX,
            ...
            deposit:      0,
            exchangeRate: 0.999999999914881374 * 1e18
        });
        _assertBorrower({
            borrower:                  _borrower,
            borrowerDebt:              0,
        ...
        _addLiquidityWithPenalty({
            ...
            index:       MAX_FENWICK_INDEX,
            lpAward:     99.986438364675091908 * 1e18,
    ...
    function testDepositTakeAndSettleByPledgeSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      0,
            exchangeRate: 0.999999999999946239 * 1e18
        });
        ...
        _removeAllLiquidity({
            from:     _borrower,
            amount:   0.000008769784221044 * 1e18,
            index:    6113,
            newLup:   MAX_PRICE,
    ...
    function testDepositTakeAndSettleByRegularTakeSubsetPool() external tearDown {
        ...
        _repayDebt({
            ...
            borrower:         _borrower2,
            amountToRepay:    6_000 * 1e18,
            amountRepaid:     5_067.483483110752298818 * 1e18,
            collateralToPull: 3,
            newLup:           MAX_PRICE
        });
        ...
        _addLiquidity({
            ...
            amount:  20_000 * 1e18,
            index:   2222,
            lpAward: 19_999.999999999999999999 * 1e18,
            newLup:  MAX_PRICE
        });
        _addLiquidity({
            from:    _lender,
            amount:  10_000 * 1e18,
            index:   2000,
            lpAward: 10_000.000000000000092004 * 1e18,
            newLup:  MAX_PRICE
        });
        uint256[] memory removalIndexes = new uint256[](2);
    ...
    function testDepositTakeAndSettleByBucketTakeSubsetPool() external tearDown {
        ...
        _depositTake({
            ...
            isReward:         true,
            lpAwardTaker:     0,
            lpAwardKicker:    857.142857142857142797 * 1e18
        });

        _assertBucket({
            index:        2502,
            lpBalance:    2_857.142857142857142797 * 1e18,
        ...
        _assertBucket({
            ...
            deposit:      0,
            exchangeRate: 0.999999999999988853 * 1e18
        });
        ...
        _addLiquidity({
            ...
            amount:  1_000 * 1e18,
            index:   6113,
            lpAward: 1_000.000000000011147000 * 1e18,
            newLup:  MAX_PRICE
        });
        uint256[] memory removalIndexes = new uint256[](3);
        ...
        _removeAllLiquidity({
            from:     _borrower,
            amount:   0.000027941032210121 * 1e18,
            index:    6113,
            newLup:   MAX_PRICE,
    ...
    function testDepositTakeAndSettleBySettleSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      1_574.549120144393919176 * 1e18,
            exchangeRate: 1.000291983507608181 * 1e18
        });
        _assertBucket({
            index:        2502,
            lpBalance:    2_857.142857142857142797 * 1e18,
        ...
        _assertBucket({
            ...
            deposit:      0,
            exchangeRate: 0.999999999990598588 * 1e18
        });
        ...
        _addLiquidity({
            ...
            amount:  1_000 * 1e18,
            index:   7388,
            lpAward: 1_000.000000009401412837 * 1e18,
            newLup:  MAX_PRICE
        });
        uint256[] memory removalIndexes = new uint256[](3);
        removalIndexes[0] = 2500;
