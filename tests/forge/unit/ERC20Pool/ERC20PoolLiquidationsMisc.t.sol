    ...
    function testLenderForcedExit() external tearDown {
        ...
        _assertPool(
            PoolParams({
                ...
                poolSize:             8_002.290256823112434919 * 1e18,
                pledgedCollateral:    1_001.742368450520005091 * 1e18,
        ...
        _assertPool(
            PoolParams({
                htp:                  0,
                lup:                  0.000000099836282890 * 1e18,
                poolSize:             8_002.657492380122502334 * 1e18,
        ...
        _assertBucket({
            index:        _i9_52,
            lpBalance:    7_920.016453607292031746 * 1e18,
            collateral:   0,          
            deposit:      470.467834275489987600 * 1e18,
            exchangeRate: 0.059402380920712387 * 1e18
        });
    }
 }
