    ...
    function testLenderForcedExit() external tearDown {
        ...
        _assertPool(
            PoolParams({
                ...
                lup:                  9.721295865031779605 * 1e18,
                poolSize:             63_008.830844290339398722 * 1e18,
                ...
                actualUtilization:    0.131774527760844779 * 1e18,
                targetUtilization:    0.822383261249738377 * 1e18,
        ...
        _removeLiquidity({
            from:     _lender,
            amount:   8_008.370021911110254226 * 1e18,
            index:    _i9_72,
        ...
        _assertPool(
            PoolParams({
                ...
                lup:                  9.529276179422528643 * 1e18,
                poolSize:             8_001.214419959675703998 * 1e18,
                pledgedCollateral:    1_001.742368450520005091 * 1e18,
                encumberedCollateral: 838.521600516187410670 * 1e18,
                poolDebt:             7_990.503913730158190391 * 1e18,
                actualUtilization:    0.390918649376855514 * 1e18,
                targetUtilization:    0.825320185632236127 * 1e18,
                minDebtAmount:        799.050391373015819039 * 1e18,
                loans:                1,
                maxBorrower:          address(_borrower2),
        ...
        _assertPool(
            PoolParams({
                ...
                poolSize:             8_002.338219653931609553 * 1e18,
                pledgedCollateral:    1_001.742368450520005091 * 1e18,
                encumberedCollateral: 81_714_595_700.439346767851204401 * 1e18,
                poolDebt:             8_158.081492591040321202 * 1e18,
                actualUtilization:    0.998661389925659374 * 1e18,
                targetUtilization:    0.838521600515024817 * 1e18,
                minDebtAmount:        0,
                loans:                0,
        ...
        _assertPool(
            PoolParams({
                htp:                  0,
                lup:                  0.000000099836282890 * 1e18,
                poolSize:             8_002.705455100713610505 * 1e18,
        ...
        _assertPool(
            PoolParams({
                htp:                  0,
                lup:                  MAX_PRICE,
                poolSize:             470.466606572217578730 * 1e18,
                pledgedCollateral:    1.742368450520005091 * 1e18,
        ...
        _assertBucket({
            index:        _i9_52,
            lpBalance:    7_920.016954393091041784 * 1e18,
            collateral:   0,          
            deposit:      470.466606572217578585 * 1e18,
            exchangeRate: 0.059402222151968779 * 1e18
        });
    }
 }
