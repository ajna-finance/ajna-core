...
contract ERC20PoolLiquidationsKickTest is ERC20HelperContract {
    ...
    function testKick() external tearDown {
        ...
        _assertPool(
            PoolParams({
                ...
                actualUtilization:    0.110929399222654499 * 1e18,
                targetUtilization:    0.833000687941443084 * 1e18,
    ...
    function testInterestsAccumulationWithAllLoansAuctioned() external tearDown {
        ...
        _addLiquidity({
            ...
            amount:  1 * 1e18,
            index:   _i9_91,
            lpAward: 0.993688621967007295 * 1e18,
            newLup:  9.721295865031779605 * 1e18
        });
