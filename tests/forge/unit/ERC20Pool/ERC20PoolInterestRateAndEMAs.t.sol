    ...
    function testPoolEMAAndTargetUtilizationUpdate() external tearDown {
        ...
        _assertPool(
            PoolParams({
                ...
                poolDebt:             1_012.343273629329809308 * 1e18,
    ...
    function testPoolLargeCollateralPostedTargetUtilization() external tearDown {
        ...
        _assertPool(
            PoolParams({
                ...
                poolDebt:             19_054.349122034189453677 * 1e18,
        ...
        _assertPool(
            PoolParams({
                ...
                poolDebt:             19_092.480394752519489738 * 1e18,
        ...
        _assertPool(
            PoolParams({
                ...
                poolDebt:             19_098.239001402275530020 * 1e18,
