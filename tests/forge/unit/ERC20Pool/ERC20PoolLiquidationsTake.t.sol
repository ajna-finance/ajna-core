    ...
    function testTakeLoanColConstraintBpfPosNoResidual() external tearDown {
        ...
        _assertAuction(
            AuctionParams({
                ...
                t0ReserveSettleAmount: 4.658321005917162001 * 1e18
            })
        );
        _assertBorrower({
            borrower:                  _borrower2,
    ...
    function testTakeAndSettle() external tearDown {
        ...
        _assertAuction(
            AuctionParams({
                ...
                t0ReserveSettleAmount: 4.672757951183434197 * 1e18
            })
        );
        _assertKicker({
            kicker:    _lender,
    ...
    function testTakeReverts() external tearDown {
        ...
        _assertAuction(
            AuctionParams({
                ...
                t0ReserveSettleAmount: 0.008229058801775144 * 1e18
            })
        );
        _assertKicker({
            kicker:    _lender,
    ...
    function testTakeRevertsOnZeroPrice() external tearDown {
        ...
        _assertAuction(
            AuctionParams({
                ...
                t0ReserveSettleAmount: 0.360923631656804907 * 1e18
            })
        );
        _assertBorrower({
            borrower:                  _borrower,
