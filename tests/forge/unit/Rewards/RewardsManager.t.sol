...
contract RewardsManagerTest is RewardsHelperContract {
    ...
    function testUpdateExchangeRatesAndClaimRewards() external {
        ...
        _updateExchangeRates({
            ...
            pool:    address(_pool),
            indexes: depositIndexes,
            reward:  4.089954136972050057 * 1e18
        });
        ...
        assertEq(_ajnaToken.balanceOf(_minterOne), 40.899541369720500568 * 1e18);

        _assertBurn({
            pool:             address(_pool),
            epoch:            1,
            timestamp:        block.timestamp - 24 hours,
            burned:           81.799082739441002012 * 1e18,
    ...
    function testWithdrawAndClaimRewardsNoExchangeRateUpdate() external {
        ...
        tokensToBurn += _triggerReserveAuctions({
            ...
            limitIndex:   2555,
            pool:         address(_pool),
            tokensToBurn: 150.531225765095992745 * 1e18
        });
        ...
        _unstakeToken({
            ...
            reward:                    78.702220033830716686 * 1e18,
            indexes:                   depositIndexes,
            updateExchangeRatesReward: 3.436607151282746921 * 1e18
        });
    }
    ...
    function testMultiPeriodRewardsSingleClaim() external {
        ...
        assertEq(rewardsEarned, 374.969146539701943260 * 1e18);
        assertLt(rewardsEarned, Maths.wmul(totalTokensBurned, 0.800000000000000000 * 1e18));
        ...
        totalTokensBurned += _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 1_030.321595435443764986 * 1e18,
            borrowAmount: 1_500 * 1e18,
            limitIndex:   6_000,
            pool:         address(_pool)
        });
        ...
        assertEq(rewardsEarnedNoUpdate, 374.969146539701943260 * 1e18);
        assertLt(rewardsEarned, Maths.wmul(totalTokensBurned, 0.800000000000000000 * 1e18));
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         14.019165117801987568 * 1e18
        });

        assertEq(_ajnaToken.balanceOf(_updater2), 14.019165117801987568 * 1e18);
        ...
        totalTokensBurned += _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 1_285.690028219559662225 * 1e18,
            borrowAmount: 1_500 * 1e18,
            limitIndex:   6_000,
            pool:         address(_pool)
        });
        ...
        totalTokensBurned += _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 1_518.007030973479013922 * 1e18,
            borrowAmount: 1_500 * 1e18,
            limitIndex:   6_000,
            pool:         address(_pool)
        });
        ...
        rewardsEarned = _rewardsManager.calculateRewards(tokenIdOne, _pool.currentBurnEpoch());
        assertEq(rewardsEarned, 491.127647916661596757 * 1e18);
        ...
        _claimRewards({
            ...
            reward:             491.127647916661596757 * 1e18
        });
    ...
    function testEarlyAndLateStakerRewards() external {
        ...
        _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 133.010720463154801131 * 1e18,
            borrowAmount: 300 * 1e18,
            limitIndex:   2555,
            pool:         address(_pool)
        });
        ...
        _unstakeToken({
            ...
            tokenId:                   tokenIdThree,
            claimedArray:              _epochsClaimedArray(1, 0),
            reward:                    33.250240325777047148 * 1e18,
            indexes:                   depositIndexes,
            updateExchangeRatesReward: 0
        });
        uint256 minterThreeBalance = _ajnaToken.balanceOf(_minterThree);
        assertEq(minterThreeBalance, 33.250240325777047148 * 1e18);
    ...
    function testClaimRewardsMultipleDepositsSameBucketsMultipleAuctions() external {
        ...
        uint256 secondTokensToBurn = _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 175.885944654845768393 * 1e18,
            borrowAmount: 300 * 1e18,
            limitIndex:   3,
            pool:         address(_pool)
        });
        ...
        assertEq(idOneRewardsAtTwo, 23.539670861841378273 * 1e18);
        ...
        assertEq(idTwoRewardsAtTwo, 23.507224958013744620 * 1e18);
        ...
        _claimRewards({
            ...
            reward:            23.539670861841378273 * 1e18
        });
        ...
        assertEq(_ajnaToken.balanceOf(_minterTwo), 31.661999680215455434 * 1e18);
    ...
    function testClaimRewardsMultipleDepositsDifferentBucketsMultipleAuctions() external {
        ...
        uint256 tokensToBurnE1 = _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 81.797607524483578206 * 1e18,
            borrowAmount: 300 * 1e18,
            limitIndex:   2555,
            pool:         address(_pool)
        });
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         4.089880376224170616 * 1e18
        });
        ...
        _assertBurn({
            ...
            epoch:            1,
            timestamp:        block.timestamp - 24 hours,
            burned:           81.797607524483578206 * 1e18,
        ...
        uint256 tokensToBurnE2 = _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 308.522250520127764584 * 1e18,
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         11.336232149782180629 * 1e18            
        });
        ...
        _assertBurn({
            ...
            epoch:            2,
            timestamp:        block.timestamp - 24 hours,
            burned:           308.522250520127764584 * 1e18,
        ...
        uint256 tokensToBurnE3 = _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 676.508959571630871477 * 1e18,
        ...
        _assertBurn({
            ...
            epoch:            3,
            timestamp:        block.timestamp - 24 hours,
            burned:           676.508959571630871477 * 1e18,
        ...
        _unstakeToken({
            ...
            reward:                    51.499239671312554526 * 1e18,
            indexes:                   firstIndexes,   
            updateExchangeRatesReward: 0
        });
        ...
        _unstakeToken({
            ...
            tokenId:                   tokenIdTwo,
            claimedArray:              _epochsClaimedArray(3, 0),
            reward:                    286.755240114502701182 * 1e18,
            indexes:                   secondIndexes,
            updateExchangeRatesReward: 0
        });
    }
    ...
    function testClaimAndWithdraw() external {
        ...
        _claimRewards({
            ...
            tokenId:            tokenIdOne,
            minAmountToReceive: 0,
            reward:             44.989495506692550625 * 1e18,
            epochsClaimed:      _epochsClaimedArray(1, 0)
        });
    ...
    function testMultiplePools() external {
        ...
        assertEq(_ajnaToken.balanceOf(_minterOne), 4.089954136972050057 * 1e18);
