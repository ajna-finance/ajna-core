...
contract RewardsManagerTest is RewardsHelperContract {
    ...
    function testMultiPeriodRewardsSingleClaim() external {
        ...
        totalTokensBurned += _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 753.761937534761336922 * 1e18,
            borrowAmount: 1_500 * 1e18,
            limitIndex:   6_000,
            pool:         address(_pool)
        });
        ...
        totalTokensBurned += _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 1_034.145224534232837796 * 1e18,
            borrowAmount: 1_500 * 1e18,
            limitIndex:   6_000,
            pool:         address(_pool)
        });
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         14.019164349973606338 * 1e18
        });
        ...
        totalTokensBurned += _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 1_289.513636917170056104 * 1e18,
            borrowAmount: 1_500 * 1e18,
            limitIndex:   6_000,
            pool:         address(_pool)
        });
        ...
        totalTokensBurned += _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 1521.830620022508618175 * 1e18,
            borrowAmount: 1_500 * 1e18,
            limitIndex:   6_000,
            pool:         address(_pool)
        });
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         11.615849155266905358 * 1e18
        });
        ...
        _claimRewards({
            ...
            reward:        493.039460320049744942 * 1e18
        });
    ...
    function testMoveStakedLiquidity() external {
        ...
        _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 149.275382184037345529 * 1e18,
            borrowAmount: 300 * 1e18,
            limitIndex:   2555,
            pool:         address(_pool)
        });
    ...
    function testEarlyAndLateStakerRewards() external {
        ...
        assertEq(_pool.bucketExchangeRate(2550), 1.000000116558299384 * 1e18);
        assertEq(_pool.bucketExchangeRate(2551), 1.000000116558299384 * 1e18);
        assertEq(_pool.bucketExchangeRate(2552), 1.000000116558299384 * 1e18);
        assertEq(_pool.bucketExchangeRate(2553), 1.000000116558299384 * 1e18);
        assertEq(_pool.bucketExchangeRate(2555), 1.000000116558299384 * 1e18);
        ...
        _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 133.010293986888191760 * 1e18,
            borrowAmount: 300 * 1e18,
            limitIndex:   2555,
            pool:         address(_pool)
        });
        ...
        _unstakeToken({
            ...
            tokenId:                   tokenIdTwo,
            claimedArray:              _epochsClaimedArray(1, 0),
            reward:                    39.906015449635181368 * 1e18,
            indexes:                   depositIndexes,
            updateExchangeRatesReward: 6.651002176006408713 * 1e18
        });

        uint256 minterTwoBalance = _ajnaToken.balanceOf(_minterTwo);
        assertEq(minterTwoBalance, 39.906015449635181368 * 1e18);
        _unstakeToken({
            owner:                     _minterThree,
            pool:                      address(_pool),
            tokenId:                   tokenIdThree,
            claimedArray:              _epochsClaimedArray(1, 0),
            reward:                    33.250133719815196731 * 1e18,
            indexes:                   depositIndexes,
            updateExchangeRatesReward: 0
        });
        uint256 minterThreeBalance = _ajnaToken.balanceOf(_minterThree);
        assertEq(minterThreeBalance, 33.250133719815196731 * 1e18);
    ...
    function testClaimRewardsMultipleDepositsSameBucketsMultipleAuctions() external {
        ...
        assertEq(_ajnaToken.balanceOf(_minterTwo), 8.154797961459414867 * 1e18);
        ...
        uint256 secondTokensToBurn = _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 176.189760225502880454 * 1e18,
            borrowAmount: 300 * 1e18,
            limitIndex:   3,
            pool:         address(_pool)
        });
        ...
        assertEq(idOneRewardsAtTwo, 23.615632136163263502 * 1e18);
        ...
        assertEq(idTwoRewardsAtTwo, 23.583081554200460059 * 1e18);
        ...
        _claimRewards({
            ...
            tokenId:       tokenIdOne,
            epochsClaimed: _epochsClaimedArray(1,1),
            reward:        23.615632136163263502 * 1e18
        });
        ...
        assertEq(_ajnaToken.balanceOf(_minterTwo), 31.737879515659874926 * 1e18);
