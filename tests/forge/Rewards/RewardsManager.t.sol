...
contract RewardsManagerTest is RewardsHelperContract {
    ...
    function testMultiPeriodRewardsSingleClaim() external {
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         20.449844540665683990 * 1e18
        });
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         17.238252336072314416 * 1e18
        });
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         14.019164349973606335 * 1e18
        });
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         11.615849155266905357 * 1e18
        });
        ...
        _claimRewards({
            ...
            reward:        493.039460320049732206 * 1e18
        });
    ...
    function testMoveStakedLiquidity() external {
        ...
        _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 529.505418197285009563 * 1e18,
            borrowAmount: 300 * 1e18,
            limitIndex:   2555,
            pool:         address(_pool)
        });
        ...
        _updateExchangeRates({
            ...
            pool:           address(_pool),
            indexes:        depositIndexes,
            reward:         3.373278067656485050 * 1e18
        });
        ...
        _claimRewards({
            ...
            reward:        33.732780676564838905 * 1e18
        });
    }
    ...
    function testEarlyAndLateStakerRewards() external {
        ...
        _triggerReserveAuctions({
            borrower:     _borrower,
            tokensToBurn: 602.051131214993198872 * 1e18,
            borrowAmount: 300 * 1e18,
            limitIndex:   2555,
            pool:         address(_pool)
        });
