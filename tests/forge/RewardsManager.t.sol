...
contract RewardsManagerTest is DSTestPlus {
    ...
    function testWithdrawAndClaimRewardsNoExchangeRateUpdate() external {
        ...
        _unstakeToken({
            ...
            reward:            94.608251013851174165 * 1e18,
            updateRatesReward: 4.882596539319977650 * 1e18
        });
    }
    ...
    function testWithdrawAndClaimRewardsNoReserveTake() external {
        ...
        _updateExchangeRates({
            ...
            pool:           address(_poolOne),
            depositIndexes: depositIndexes,
            reward:         5.121149596645163440 * 1e18
        });
    }
    ...
    function testMultiPeriodRewardsSingleClaim() external {
        ...
        assertEq(_ajnaToken.balanceOf(_updater), 20.449844540665683990 * 1e18);
        vm.expectEmit(true, true, true, true);
        emit UpdateExchangeRates(_updater, address(_poolOne), depositIndexes, 23.722014025047249985 * 1e18);
        _rewardsManager.updateBucketExchangeRatesAndClaim(address(_poolOne), depositIndexes);
        assertEq(_ajnaToken.balanceOf(_updater), 44.171858565712933975 * 1e18);

        // check available rewards
        rewardsEarned = _rewardsManager.calculateRewards(tokenIdOne, _poolOne.currentBurnEpoch());
        assertEq(rewardsEarned, 441.718585657129427747 * 1e18);
        assertLt(rewardsEarned, Maths.wmul(totalTokensBurned, 0.800000000000000000 * 1e18));
        ...
        assertEq(rewardsEarnedNoUpdate, 441.718585657129427747 * 1e18);
        assertLt(rewardsEarned, Maths.wmul(totalTokensBurned, 0.800000000000000000 * 1e18));
        ...
        vm.expectEmit(true, true, true, true);
        emit UpdateExchangeRates(_updater2, address(_poolOne), depositIndexes, 26.264944064282372211 * 1e18);
        _rewardsManager.updateBucketExchangeRatesAndClaim(address(_poolOne), depositIndexes);
        assertEq(_ajnaToken.balanceOf(_updater2), 26.264944064282372211 * 1e18);

        // check available rewards
        rewardsEarned = _rewardsManager.calculateRewards(tokenIdOne, _poolOne.currentBurnEpoch());
        assertEq(rewardsEarned, 704.368026299952816344 * 1e18);
        ...
        assertEq(_ajnaToken.balanceOf(_updater2), 0);
        vm.expectEmit(true, true, true, true);
        emit UpdateExchangeRates(_updater2, address(_poolOne), depositIndexes, 22.065570319555002190 * 1e18);
        _rewardsManager.updateBucketExchangeRatesAndClaim(address(_poolOne), depositIndexes);
        assertEq(_ajnaToken.balanceOf(_updater2), 22.065570319555002190 * 1e18);

        rewardsEarned = _rewardsManager.calculateRewards(tokenIdOne, _poolOne.currentBurnEpoch());
        assertEq(rewardsEarned, 662.374288852678423096 * 1e18);
    ...
    function testEarlyAndLateStakerRewards() external {
        ...
        _unstakeToken({
            ...
            tokenId:           tokenIdTwo,
            claimedArray:      _epochsClaimedArray(1, 0),
            reward:            39.908290760110226759 * 1e18,
            updateRatesReward: 0
        });
        uint256 minterTwoBalance = _ajnaToken.balanceOf(_minterTwo);
        assertEq(minterTwoBalance, 39.908290760110226759 * 1e18);
        _unstakeToken({
            minter:            _minterThree,
            pool:              address(_poolOne),
            tokenId:           tokenIdThree,
            claimedArray:      _epochsClaimedArray(1, 0),
            reward:            33.248355603346043985 * 1e18,
            updateRatesReward: 0
        });
        uint256 minterThreeBalance = _ajnaToken.balanceOf(_minterThree);
        assertEq(minterThreeBalance, 33.248355603346043985 * 1e18);
    ...
    function testClaimRewardsMultipleDepositsSameBucketsMultipleAuctions() external {
        ...
        _stakeToken(address(_poolOne), _minterTwo, tokenIdTwo);
        assertEq(_ajnaToken.balanceOf(_minterTwo), 8.175426995292275644 * 1e18);
        ...
        assertEq(_ajnaToken.balanceOf(_minterTwo), idTwoRewardsAtTwo + 8.175426995292275644 * 1e18);
    ...
    function testClaimRewardsMultipleDepositsDifferentBucketsMultipleAuctions() external {
        ...
        _updateExchangeRates({
            ...
            pool:           address(_poolOne),
            depositIndexes: depositIndexes,
            reward:         16.278105055228781700 * 1e18
        });
        ...
        _updateExchangeRates({
            ...
            pool:           address(_poolOne),
            depositIndexes: depositIndexes,
            reward:         27.759277653166862180 * 1e18
        });
        ...
        _assertBurn({
            ...
            burned:    407.361479267233771562 * 1e18,
            interest:  32.725723206162252948 * 1e18
        });
        ...
        _assertBurn({
            ...
            epoch:     3,
            timestamp: block.timestamp - 24 hours,
            burned:    962.547032330564034342 * 1e18,
            interest:  75.664169990581363235 * 1e18
        });
        ...
        _unstakeToken({
            ...
            reward:            80.212252694213655905 * 1e18,
            updateRatesReward: 0
        });
        ...
        _unstakeToken({
            ...
            tokenId:           tokenIdTwo,
            claimedArray:      _epochsClaimedArray(3, 0),
            reward:            401.061263471068279515 * 1e18,
            updateRatesReward: 0
        });
    }
