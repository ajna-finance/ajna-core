...
contract ERC721PoolPurchaseQuoteTest is ERC721HelperContract {
    ...
    function testSubsetPurchaseQuoteWithDebt() external {
        ...
        uint256 amountWithInterest = 24_002.700459932860704000 * 1e18;
        ...
        _removeAllLiquidity({
            ...
            lpRedeem: 24_000.766698838362466044 * 1e18
        });
        ...
        _assertBucket({
            index:        2350,
            lpBalance:    32_653.710158208991904581 * 1e18,
            collateral:   Maths.wad(4),
            deposit:      0,
            exchangeRate: 1.000080570805039816 * 1e18
        });
        ...
        (uint256 amount) = _removeCollateral({
            ...
            amount:   1,
            index:    2350,
            lpRedeem: 8_163.427539552247977531 * 1e18
        });

        _assertLenderLpBalance({
            lender:      _bidder,
            index:       2350,
            lpBalance:   490.282618656743927050 * 1e18,
        ...
        _assertBucket({
            index:        2350,
            lpBalance:    16_326.855079104495949519 * 1e18,
