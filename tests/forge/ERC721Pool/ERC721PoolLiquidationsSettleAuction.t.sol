...
contract ERC721PoolLiquidationsSettleAuctionTest is ERC721HelperContract {
    ...
    function testSettlePartialDebtSubsetPool() external tearDown {
        ...
        _settle({
            ...
            borrower:    _borrower,
            maxDepth:    1,
            settledDebt: 4_996.799887883802397930 * 1e18
        });
        ...
        _assertBucket({
            index:        2500,
            lpBalance:    4_997.115384615384614 * 1e18,
            collateral:   1.293874031008720309 * 1e18,
            deposit:      0,
        ...
        _assertBorrower({
            borrower:                  _borrower,
            borrowerDebt:              70.600130721308261690 * 1e18,
            borrowerCollateral:        0.706125968991279691 * 1e18,
            borrowert0Np:              2_627.524038461538462750 * 1e18,
        ...
        _assertBucket({
            index:        2500,
            lpBalance:    24_989.247267890536762825 * 1e18,
            collateral:   1.293874031008720309 * 1e18,
            deposit:      20_000 * 1e18,
            exchangeRate: 1.000393560665305039 * 1e18
        });
        ...
        _settle({
            ...
            borrower:    _borrower,
            maxDepth:    1,
            settledDebt: 70.567900577736065945 * 1e18
        });
        ...
        _assertBucket({
            ...
            deposit:      19_929.399869278691738310 * 1e18,
            exchangeRate: 1.000393560665305039 * 1e18
        });
        _assertBorrower({
            borrower:                  _borrower,
        ...
        _assertBucket({
            ...
            deposit:      14_859.717685886623586002 * 1e18,
            exchangeRate: 1.000393560665305039 * 1e18
        });
        _assertBucket({
            index:        7388,
        ...
        _assertBucket({
            index:        2500,
            lpBalance:    14_853.871786224081491640 * 1e18,
            collateral:   0,
            deposit:      14_859.717685886623586002 * 1e18,
            exchangeRate: 1.000393560665305039 * 1e18
        });
    ...
    function testDepositTakeAndSettleSubsetPool() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      1_575.832203600893201193 * 1e18,
            exchangeRate: 1.000608914439502933 * 1e18
        });
        _assertBucket({
            index:        MAX_FENWICK_INDEX,
    ...
    function testDepositTakeAndSettleBySettleSubsetPool() external {
        ...
        _assertBucket({
            ...
            deposit:      1_574.562221972620119500 * 1e18,
            exchangeRate: 1.000350925539482345 * 1e18
        });
        _assertBucket({
            index:        2502,
            lpBalance:    2_857.142857142857142798 * 1e18,
