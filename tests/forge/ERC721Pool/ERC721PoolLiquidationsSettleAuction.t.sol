...
contract ERC721PoolLiquidationsSettleAuctionTest is ERC721HelperContract {
    ...
    function testSettlePartialDebtSubsetPool() external tearDown {
        ...
        _assertBucket({
            index:        MAX_FENWICK_INDEX,
            lpBalance:    100.000000000000000000728091500 * 1e27,
            collateral:   0,
            deposit:      100 * 1e18,
            exchangeRate: 0.999999999999999999992719085 * 1e27
        });
        _assertBorrower({
            borrower:                  _borrower,
            borrowerDebt:              0,
    ...
    function testDepositTakeAndSettleSubsetPool() external tearDown {
        ...
        _assertBucket({
            index:        2500,
            lpBalance:    7_138.736263736263734673928111481 * 1e27,
            collateral:   1.848006454703595366 * 1e18,
            deposit:      0,
            exchangeRate: 1.000185179648802797127076553 * 1e27
        });
        _assertBorrower({
            borrower:                  _borrower,
    ...
    function testDepositTakeAndSettleByPledgeSubsetPool() external tearDown {
        ...
        _depositTake({
            ...
            isReward:         true,
            lpAwardTaker:     0,
            lpAwardKicker:    2_141.620879120879120673928111481 * 1e27
        });
    ...
    function testDepositTakeAndSettleByBucketTakeSubsetPool() external tearDown {
        ...
        _depositTake({
            ...
            isReward:         true,
            lpAwardTaker:     0,
            lpAwardKicker:    857.142857142857143034252917107 * 1e27
        });

        _assertBucket({
            index:        2502,
            lpBalance:    2_857.142857142857143034252917107 * 1e27,
            collateral:   0.747044074730990508 * 1e18,
            deposit:      0,
            exchangeRate: 1.000185179648802797144379379 * 1e27
        });
        _assertBorrower({
            borrower:                  _borrower,
        ...
        _depositTake({
            ...
            isReward:         true,
            lpAwardTaker:     0,
            lpAwardKicker:    1_466.872971297977726513000000000 * 1e27
        });
        ...
        _assertBucket({
            index:        2400,
            lpBalance:    11_466.872971297977726513000000000 * 1e27,
            collateral:   0.768540585971418892 * 1e18,
            deposit:      6_577.296400304718638136 * 1e18,
            exchangeRate: 0.999999999999999999869851402 * 1e27
        });
        _assertBucket({
            index:        6113,
