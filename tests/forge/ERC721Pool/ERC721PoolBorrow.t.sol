    ...
    function testBorrowAndRepay() external {
        ...
        _assertPool(
            PoolParams({
                ...
                targetUtilization:    9.977881336769365555 * 1e18, // TODO: why is this number so large?
        ...
        _repayDebt({
            ...
            amountRepaid:     1_509.066774239163546755 * 1e18,
            collateralToPull: 3,
            newLup:           MAX_PRICE
        });
        ...
        _assertPool(
            PoolParams({
                ...
                poolDebt:             0,
                actualUtilization:    0.100221676952091274 * 1e18,
                targetUtilization:    9.977881336769365555 * 1e18, // TODO: review
                minDebtAmount:        0,
                loans:                0,
                maxBorrower:          address(0),
        ...
        _assertEMAs({
            ...
            lupColEma: 30_003.498905447098710000 * 1e18
        });
