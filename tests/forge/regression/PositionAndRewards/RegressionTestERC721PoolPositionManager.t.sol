...
contract RegressionTestERC721PoolPositionsManager is ERC721PoolPositionsInvariants {
    ...
    function test_regression_failure_no_allowance_err() external {
        _erc721positionHandler.moveLiquidity(2, 2726918499846956781196026606977128745, 4671573035498269269631531108867257349254074281251805650007376127, 65229405930547405981803897204924144159227983393929014243, 136472940433983213576424627235038299016985732062067347200674016);
