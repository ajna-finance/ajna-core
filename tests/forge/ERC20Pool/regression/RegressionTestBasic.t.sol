...
contract RegressionTestBasic is BasicInvariants { 
    ...
    function test_regression_invariant_fenwick_value_F1() external {
        _basicPoolHandler.repayDebt(3, 344770310598800153195398681);
        _basicPoolHandler.addQuoteToken(37948765394219409434752950975996696521011492538373651076725741664179800736806, 6731,
                      21098442490310101577650093926296080013748622367525834525955120384295562225);
        _basicPoolHandler.addCollateral(1237594141, 3, 13513339724057404057752313);
        _basicPoolHandler.removeQuoteToken(115792089237316195423570985008687907853269984665640564039457584007913129639935,
                                                 25716258957671191170, 1);
        _basicPoolHandler.pledgeCollateral(1707382187, 2000007002745518794781202055366);
        _basicPoolHandler.drawDebt(2087799897622843778310847461086610980826227789048548117049587,
                 115792089237316195423570985008687907853269984665640564039457584007913129639934);
        _basicPoolHandler.repayDebt(8068470438037086651579040706165041693911246962842773157727419418631, 1943013693);

        invariant_fenwick_depositAtIndex_F1();
    }

    function test_regression_invariant_fenwick_value_F2() external {
        _basicPoolHandler.repayDebt(3, 344770310598800153195398681);
        // 689540621197600306390797362  1672372187
        _basicPoolHandler.addQuoteToken(37948765394219409434752950975996696521011492538373651076725741664179800736806, 6731,
                                        21098442490310101577650093926296080013748622367525834525955120384295562225);
        _basicPoolHandler.addCollateral(1237594141, 3, 13513339724057404057752313);
        _basicPoolHandler.removeQuoteToken(115792089237316195423570985008687907853269984665640564039457584007913129639935,
        ...
        _basicPoolHandler.repayDebt(8068470438037086651579040706165041693911246962842773157727419418631, 1943013693);
        //  ===================Bucket Index :  2570  ===================
        //  Prefix Sum From Pool               --> 3936323871560988289594288287
        //  Prefix Sum From local fenwick tree --> 3936348802773494663356097130
        //  =========================================
        invariant_fenwick_depositsTillIndex_F2();
    }
}
