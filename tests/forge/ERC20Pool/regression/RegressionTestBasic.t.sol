...
contract RegressionTestBasic is BasicInvariants { 
    ...
    function test_regression_exrate_1() external {
        _basicPoolHandler.addCollateral(248025400361255504122928474157338684338730018290, 115792089237316195423570985008687907853269984665640564039457584007913129639933, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
        _basicPoolHandler.addCollateral(1, 3, 115792089237316195423570985008687907853269984665640564039457584007913129639935);

        invariant_exchangeRate_R1_R2_R3_R4_R5_R6_R7_R8();
     }

    function test_regression_exrate_2() external {
        _basicPoolHandler.addCollateral(2, 29966147928, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
        _basicPoolHandler.removeCollateral(2204289587109424861813324998256220717554340455520, 2, 11657395468745235993156171781745490585669103966443);

        invariant_exchangeRate_R1_R2_R3_R4_R5_R6_R7_R8();
    }

    function test_regression_exrate_3() external {
        _basicPoolHandler.transferLps(115792089237316195423570985008687907853269984665640564039457584007913129639934, 7966823552037619668520219535571849568576, 113161, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
        _basicPoolHandler.moveQuoteToken(35997434347535016, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 2197095775087354869386167620087519185595313282885404930, 2);
        _basicPoolHandler.addCollateral(7048660050580786684, 3, 2);
