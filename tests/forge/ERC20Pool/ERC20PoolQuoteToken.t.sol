...
contract ERC20PoolQuoteTokenTest is ERC20HelperContract {
    ...
    function testPoolRemoveQuoteTokenWithDebt() external tearDown {
        ...
        _removeLiquidity({
            ...
            lpRedeem:      1_699.988264063119375503 * 1e18
        });
        ...
        uint256 expectedWithdrawal2 = 1_700.147864111729705749 * 1e18;
        _removeAllLiquidity({
            from:     _lender,
            amount:   expectedWithdrawal2,
            index:    1606,
            newLup:   _priceAt(1663),
            lpRedeem: 1_700.011735936880624497 * 1e18
        });
        ...
        _assertBucket({
            ...
            lpBalance:    3_400 * 1e18,
            collateral:   0,
            deposit:      3_400.272254470191528600 * 1e18,
            exchangeRate: 1.000080074844173979 * 1e18
        });
        _assertLenderLpBalance({
            lender:      _lender,
            index:       1663,
    ...
    function testAddRemoveQuoteTokenBucketExchangeRateInvariantDifferentActor() tearDown external {
        _mintQuoteAndApproveTokens(_lender, 0.999999989125110330 * 1e18);
