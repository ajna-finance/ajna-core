...
contract ERC20PoolQuoteTokenTest is ERC20HelperContract {
    ...
    function testPoolRemoveQuoteTokenWithDebt() external tearDown {
        ...
        _removeLiquidity({
            ...
            lpRedeem:      1_699.989134088091858193 * 1e18
        });
        ...
        uint256 expectedWithdrawal2 = 1_700.143566438945433190 * 1e18;
        _removeAllLiquidity({
            from:     _lender,
            amount:   expectedWithdrawal2,
            index:    1606,
            newLup:   _priceAt(1663),
            lpRedeem: 1_700.010865911908141807 * 1e18
        });
        ...
        _assertBucket({
            ...
            lpBalance:    3_400 * 1e18,
            collateral:   0,
            deposit:      3_400.265399357718087800 * 1e18,
            exchangeRate: 1.000078058634622967 * 1e18
        });
        _assertLenderLpBalance({
            lender:      _lender,
            index:       1663,
    ...
    function testMoveQuoteTokenWithDebt() external tearDown {
        ...
        _addLiquidity({
            ...
            amount:  1_000 * 1e18,
            index:   2873,
            lpAward: 999.957736665887433821 * 1e18,
            newLup:  601.252968524772188572 * 1e18
        });
        ...
        _moveLiquidity({
            ...
            fromIndex:    2873,
            toIndex:      2954,
            lpRedeemFrom: 2_499.803998131605007906 * 1e18,
            lpAwardTo:    2_500 * 1e18,
            newLup:       _lup()
        });
        ...
        _addLiquidity({
            ...
            amount:  9_000 * 1e18,
            index:   2873,
            lpAward: 8_993.517389515901117816 * 1e18,
            newLup:  601.252968524772188572 * 1e18
        });
        ...
        _removeAllLiquidity({
            from:     _lender,
            amount:   5_003.905260769531499021* 1e18,
            index:    2873,
            newLup:   601.252968524772188572 * 1e18,
            lpRedeem: 5_000.293127793384007274 * 1e18
        });
