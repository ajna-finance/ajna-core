...
contract ERC20PoolLiquidationsArbTakeTest is ERC20HelperContract {
    ...
    function testArbTakeCollateralRestrict() external tearDown {
        ...
        _assertBucket({
            ...
            lpBalance:    2_000 * 1e18,
            collateral:   0,
            deposit:      2_010.436714496623126000 * 1e18,
            exchangeRate: 1.005218357248311563 * 1e18
        });
        _assertReserveAuction({
            reserves:                   24.540805142364598538 * 1e18,
            claimableReserves :         0,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        ...
        _arbTake({
            ...
            isReward:         true,
            lpAwardTaker:     5.303234072524906823 * 1e18,
        ...
        _assertLenderLpBalance({
            lender:      _taker,
            index:       _i9_91,
            lpBalance:   5.303234072524906823 * 1e18,
        ...
        _assertBucket({
            index:        _i9_91,
            lpBalance:    2_005.447515773508630329 * 1e18,
            collateral:   2 * 1e18,
            deposit:      1_996.078287666681912514 * 1e18,
            exchangeRate: 1.005218357248311563 * 1e18
        });
        // reserves should remain the same after arb take
        _assertReserveAuction({
            reserves:                   25.925343323521952868 * 1e18,
            claimableReserves :         0,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
