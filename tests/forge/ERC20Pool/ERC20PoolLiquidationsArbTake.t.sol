...
contract ERC20PoolLiquidationsArbTakeTest is ERC20HelperContract {
    ...
    function testArbTakeCollateralRestrict() external tearDown {
        ...
        _addLiquidityWithPenalty({
            ...
            index:       _i9_52,
            lpAward:     0.999873539225944870 * 1e18,
            newLup:      9.721295865031779605 * 1e18
        });
        ...
        _assertBucket({
            ...
            lpBalance:    2_000 * 1e18,
            collateral:   0,
            deposit:      2_010.436714496623128000 * 1e18,
            exchangeRate: 1.005218357248311564 * 1e18
        });
        _assertReserveAuction({
            reserves:                   24.540805142364525444 * 1e18,
            claimableReserves :         0,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        ...
        _arbTake({
            ...
            isReward:         true,
            lpAwardTaker:     5.303234072524906818 * 1e18,
            lpAwardKicker:    0.144281700983723506 * 1e18
        });

        _assertLenderLpBalance({
            lender:      _taker,
            index:       _i9_91,
            lpBalance:   5.303234072524906818 * 1e18,
        ...
        _assertBucket({
            index:        _i9_91,
            lpBalance:    2_005.447515773508630324 * 1e18,
            collateral:   2 * 1e18,
            deposit:      1_996.078287666681914514 * 1e18,
            exchangeRate: 1.005218357248311564 * 1e18
        });
        // reserves should remain the same after arb take
        _assertReserveAuction({
            reserves:                   25.925343323521879774 * 1e18,
            claimableReserves :         0,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
    ...
    function testArbTakeDebtRestrict() external tearDown {
        ...
        _assertReserveAuction({
            reserves:                   26.111530884129153302 * 1e18,
            claimableReserves :         0,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
