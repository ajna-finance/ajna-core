...
contract ERC20PoolLiquidationsArbTakeTest is ERC20HelperContract {
    ...
    function testArbTakeCollateralRestrict() external tearDown {
        ...
        _assertBucket({
            ...
            lpBalance:    2_000 * 1e18,
            collateral:   0,
            deposit:      2_026.820859853884156000 * 1e18,
            exchangeRate: 1.013410429926942078 * 1e18
        });
        _assertBorrower({
            borrower:                  _borrower,
        ...
        _addLiquidityWithPenalty({
            ...
            index:       _i9_52,
            lpAward:     0.999873539225944871 * 1e18,
            newLup:      9.721295865031779605 * 1e18
        });
        ...
        _assertBucket({
            ...
            lpBalance:    2_000 * 1e18,
            collateral:   0,
            deposit:      2_026.827291978286188000 * 1e18,
            exchangeRate: 1.013413645989143094 * 1e18
        });
        _assertReserveAuction({
            reserves:                   24.540805142364596538 * 1e18,
            claimableReserves :         0,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        ...
        _arbTake({
            ...
            isReward:         true,
            lpAwardTaker:     5.260347799326822092 * 1e18,
            lpAwardKicker:    0.143114921550409463 * 1e18
        });

        _assertLenderLpBalance({
            lender:      _taker,
            index:       _i9_91,
            lpBalance:   5.260347799326822092 * 1e18,
            depositTime: _startTime + 100 days + 6.5 hours
        });
        _assertLenderLpBalance({
            lender:      _lender,
            index:       _i9_91,
            lpBalance:   2_000.143114921550409463 * 1e18, // rewarded with LPs in bucket
            depositTime: _startTime + 100 days + 6.5 hours
        });
        _assertBucket({
            index:        _i9_91,
            lpBalance:    2_005.403462720877231555 * 1e18,
            collateral:   2 * 1e18,
            deposit:      2_012.468865148344974514 * 1e18,
            exchangeRate: 1.013413645989143094 * 1e18
        });
        // reserves should remain the same after arb take
        _assertReserveAuction({
            reserves:                   25.925343323521950876 * 1e18,
            claimableReserves :         0,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
    ...
    function testArbTakeDebtRestrict() external tearDown {
        ...
        _assertReserveAuction({
            reserves:                   26.111530884129151301 * 1e18,
            claimableReserves :         0,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
