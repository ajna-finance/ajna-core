...
contract ERC20PoolLiquidationsSettleTest is ERC20HelperContract {
    ...
    function testSettleOnAuctionKicked72HoursAgoAndPartiallyTaken() external tearDown {
        ...
        _assertBucket({
            ...
            collateral:   0,
            deposit:      2_114.174951097528960000 * 1e18,
            exchangeRate: 1.057087475548764480 * 1e18
        });
        _assertBucket({
            index:        _i9_81,
        ...
        _assertBucket({
            ...
            lpBalance:    5_000 * 1e18,
            collateral:   0,
            deposit:      5_000.319586842611440000 * 1e18,
            exchangeRate: 1.000063917368522288 * 1e18
        });
        _assertBucket({
            index:        _i9_72,
            lpBalance:    11_000 * 1e18,
        ...
        _assertBucket({
            ...
            lpBalance:    11_000 * 1e18,
            collateral:   0,
            deposit:      8_807.556879218687261285 * 1e18,
        ...
        _assertPool(
            PoolParams({
                ...
                lup:                  9.721295865031779605 * 1e18,
                poolSize:             63_807.556879218687261285 * 1e18,
    ...
    function testSettleOnAuctionKicked72HoursAgo() external tearDown {
        ...
        _assertBucket({
            index:        _i9_91,
            lpBalance:    2_000 * 1e18,
            collateral:   213.282459829062995170 * 1e18,
            deposit:      0,
            exchangeRate: 1.057580788993756153 * 1e18
        });
        _assertBucket({
            index:        _i9_81,
            lpBalance:    5_000 * 1e18,
            collateral:   509.467337074016312678 * 1e18,
            deposit:      0,
            exchangeRate: 1.000466672301396419 * 1e18
        });
        _assertBucket({
            index:        _i9_72,
            lpBalance:    11_000 * 1e18,
    ...
    function testSettleAuctionReverts() external tearDown {
        ...
        _addLiquidity({
            ...
            amount:  100 * 1e18,
            index:   _i9_91,
            lpAward: 94.593504307441637789 * 1e18,
            newLup:  9.721295865031779605 * 1e18
        });
        ...
        _assertLenderLpBalance({
            lender:      _lender1,
            index:       _i9_91,
            lpBalance:   94.593504307441637789 * 1e18,
...
contract ERC20PoolLiquidationsSettleRegressionTest is ERC20HelperContract {
    ...
    function testSettleWithReserves() external tearDown {
        ...
        _startClaimableReserveAuction({
            from:              actor1,
            remainingReserves: 1_962_000_500.669895903463292555 * 1e18,
