...
contract ERC20PoolLiquidationsSettleTest is ERC20HelperContract {
    ...
    function testSettleOnAuctionKicked72HoursAgoAndPartiallyTaken() external tearDown {
        ...
        _assertBucket({
            ...
            lpBalance:    5_000 * 1e18,
            collateral:   0,
            deposit:      5_031.841575122113960000 * 1e18,
            exchangeRate: 1.006368315024422792 * 1e18
        });
        _assertBucket({
            index:        _i9_72,
            lpBalance:    11_000 * 1e18,
            collateral:   0,
            deposit:      11_070.051465268650712000 * 1e18,
            exchangeRate: 1.006368315024422792 * 1e18
        });
        _assertBucket({
            index:        _i9_62,
        ...
        _assertBucket({
            ...
            lpBalance:    11_000 * 1e18,
            collateral:   0,
            deposit:      8_807.556879218687263263 * 1e18,
    ...
    function testSettleAuctionReverts() external tearDown {
        ...
        _addLiquidity({
            ...
            amount:  100 * 1e18,
            index:   _i9_91,
            lpAward: 99.367198377636894880 * 1e18,
            newLup:  9.721295865031779605 * 1e18
        });
        ...
        _assertLenderLpBalance({
            lender:      _lender1,
            index:       _i9_91,
            lpBalance:   99.367198377636894880 * 1e18,
        ...
        _assertBucket({
            ...
            lpBalance:    11_000 * 1e18,
            collateral:   0 * 1e18,
            deposit:      9_036.878038705612120074 * 1e18,
            exchangeRate: 0.821534367155055647 * 1e18
        });
