...
contract ERC20PoolLiquidationsDepositTakeTest is ERC20HelperContract {
    ...
    function testDepositTakeCollateralRestrict() external tearDown {
        ...
        _addLiquidityWithPenalty({
            ...
            index:       _i9_52,
            lpAward:     0.999873479213875107 * 1e18,
            newLup:      9.721295865031779605 * 1e18
        });
        ...
        _assertBucket({
            ...
            lpBalance:    2_000 * 1e18,
            collateral:   0,
            deposit:      2_026.352753018872710000 * 1e18,
            exchangeRate: 1.013176376509436355 * 1e18
        });
        _assertReserveAuction({
            reserves:                   49.824792135962495178 * 1e18,
            claimableReserves :         8.392655686771763036 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
        ...
        _assertBucket({
            ...
            lpBalance:    2_000.195764233619466887 * 1e18,
            collateral:   2 * 1e18,
            deposit:      2_006.716727028869604094 * 1e18,
            exchangeRate: 1.013176376509436355 * 1e18
        });
        // reserves should remain the same after deposit take
        _assertReserveAuction({
            reserves:                   51.238074032610772536 * 1e18,
            claimableReserves :         9.897051303886814537 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
    ...
    function testDepositTakeDebtRestrict() external tearDown {
        ...
        _assertReserveAuction({
            reserves:                   51.428137480706929985 * 1e18,
            claimableReserves :         10.097268213810519087 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
