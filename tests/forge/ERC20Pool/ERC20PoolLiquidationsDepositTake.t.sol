...
contract ERC20PoolLiquidationsDepositTakeTest is ERC20HelperContract {
    ...
    function testDepositTakeCollateralRestrict() external tearDown {
        ...
        _addLiquidityWithPenalty({
            ...
            index:       _i9_52,
            lpAward:     0.999873491089699926 * 1e18,
            newLup:      9.721295865031779605 * 1e18
        });
        ...
        _assertBucket({
            ...
            lpBalance:    2_000 * 1e18,
            collateral:   0,
            deposit:      2_000.006443293268404000 * 1e18,
            exchangeRate: 1.000003221646634202 * 1e18
        });
        _assertReserveAuction({
            reserves:                   286.942232921520915220 * 1e18,
            claimableReserves :         245.510096472330183078 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
        ...
        _depositTake({
            ...
            isReward:         true,
            lpAwardTaker:     0,
            lpAwardKicker:    0.198343057877473413 * 1e18
        });
        ...
        _assertLenderLpBalance({
            lender:      _lender,
            index:       _i9_91,
            lpBalance:   2_000.198343057877473413 * 1e18,
        ...
        _assertBucket({
            ...
            lpBalance:    2_000.198343057877473413 * 1e18,
            collateral:   2 * 1e18,
            deposit:      1_980.370417303265298094 * 1e18,
            exchangeRate: 1.000003221646634202 * 1e18
        });
        // reserves should remain the same after deposit take
        _assertReserveAuction({
            reserves:                   288.355514818169192571 * 1e18,
            claimableReserves :         247.014492089445234572 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
    ...
    function testDepositTakeDebtRestrict() external tearDown {
        ...
        _assertReserveAuction({
            reserves:                   288.545201238187141870 * 1e18,
            claimableReserves :         247.214331971290730972 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
