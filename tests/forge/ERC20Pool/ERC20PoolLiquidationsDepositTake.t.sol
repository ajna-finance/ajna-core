...
contract ERC20PoolLiquidationsDepositTakeTest is ERC20HelperContract {
    ...
    function testDepositTakeCollateralRestrict() external tearDown {
        ...
        _assertReserveAuction({
            reserves:                   286.940599154163873220 * 1e18,
            claimableReserves :         245.508462704973141078 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
        ...
        _assertReserveAuction({
            reserves:                   288.353881050812150571 * 1e18,
            claimableReserves :         247.012858322088192572 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
