...
contract ERC20PoolLiquidationsDepositTakeTest is ERC20HelperContract {
    ...
    function testDepositTakeCollateralRestrict() external tearDown {
        ...
        _addLiquidityWithPenalty({
            ...
            index:       _i9_52,
            lpAward:     0.999873479213875106 * 1e18,
            newLup:      9.721295865031779605 * 1e18
        });
        ...
        _assertBucket({
            ...
            lpBalance:    2_000 * 1e18,
            collateral:   0,
            deposit:      2_026.352753018872712000 * 1e18,
            exchangeRate: 1.013176376509436356 * 1e18
        });
        _assertReserveAuction({
            reserves:                   49.824792135962421941 * 1e18,
            claimableReserves :         8.392655686771689799 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
        ...
        _depositTake({
            ...
            isReward:         true,
            lpAwardTaker:     0,
            lpAwardKicker:    0.195764233619466887 * 1e18
        });
        ...
        _assertLenderLpBalance({
            lender:      _lender,
            index:       _i9_91,
            lpBalance:   2_000.195764233619466887 * 1e18,
        ...
        _assertBucket({
            ...
            lpBalance:    2_000.195764233619466887 * 1e18,
            collateral:   2 * 1e18,
            deposit:      2_006.716727028869606094 * 1e18,
            exchangeRate: 1.013176376509436356 * 1e18
        });
        // reserves should remain the same after deposit take
        _assertReserveAuction({
            reserves:                   51.238074032610699299 * 1e18,
            claimableReserves :         9.897051303886741300 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
    ...
    function testDepositTakeDebtRestrict() external tearDown {
        ...
        _assertBucket({
            ...
            deposit:      24_978.397143183672680232 * 1e18,
            exchangeRate: 1 * 1e18
        });
        _assertReserveAuction({
            reserves:                   51.428137480706856748 * 1e18,
            claimableReserves :         10.097268213810445850 * 1e18,
            claimableReservesRemaining: 0,
            auctionPrice:               0,
            timeRemaining:              0
        });
