    ...
    function testInterestsAccumulationWithAllLoansAuctioned() external tearDown {
        ...
        _assertPool(
            PoolParams({
                ...
                actualUtilization:    0,
                targetUtilization:    1.039018638274467457 * 1e18,
                minDebtAmount:        0,
                loans:                0,
                maxBorrower:          address(0),
                interestRate:         0.045 * 1e18,
        ...
        _addLiquidity({
            ...
            amount:  1 * 1e18,
            index:   _i9_91,
            lpAward: 0.945987598061392803 * 1e18,
            newLup:  9.721295865031779605 * 1e18
        });
