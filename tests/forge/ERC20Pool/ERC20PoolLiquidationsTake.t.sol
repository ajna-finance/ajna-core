...
contract ERC20PoolLiquidationsTakeTest is ERC20HelperContract {
    ...
    function testTakeLoanColConstraintBpfPosNoResidual() external tearDown {
        ...
        _take(
            {
                ...
                bondChange:      3_394.689000808803408000 * 1e18,
        ...
        _assertAuction(
            AuctionParams({
                ...
                bondSize:          6_341.574364218449098939 * 1e18,
                bondFactor:        0.3 * 1e18,
                kickTime:          block.timestamp - 47000 seconds,
                kickMomp:          1_505.263728469068226832 * 1e18,
                totalBondEscrowed: 6_341.574364218449098939 * 1e18,
                auctionPrice:      11.315630002696011360 * 1e18,
                debtInAuction:     12_668.117652063270801034 * 1e18,
                thresholdPrice:    0,
                neutralPrice:      1_597.054445085392479852 * 1e18
            })
        );
        ...
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              12_668.117652063270801034 * 1e18,
    ...
    function testTakeCallerColConstraintBpfPosNoResidual() external tearDown {
        ...
        _take(
            {
                ...
                borrower:        _borrower2,
                maxCollateral:   10 * 1e18,
                bondChange:      73.150061412066363371 * 1e18,
        ...
        _assertAuction(
            AuctionParams({
                ...
                active:            true,
                kicker:            _lender,
                bondSize:          3_020.035424821712054310 * 1e18,
                bondFactor:        0.3 * 1e18,
                kickTime:          block.timestamp - 43000 seconds,
                kickMomp:          1_505.263728469068226832 * 1e18,
                totalBondEscrowed: 3_020.035424821712054310 * 1e18,
                auctionPrice:      24.443112772227665888 * 1e18,
                debtInAuction:     20_417.660070517578211182 * 1e18,
                thresholdPrice:    20.623899061128866879 * 1e18,
                neutralPrice:      1_597.054445085392479852 * 1e18
            })
        );
        ...
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              20_417.660070517578211182 * 1e18,
                borrowerCollateral:        990 * 1e18,
                borrowert0Np:              1_575.326150647652569911 * 1e18,
                borrowerCollateralization: 0.466682228447369894 * 1e18
            }
        );
    }
    ...
    function testTakeCallerColConstraintBpfPosResidual () external tearDown {
        ...
        _take(
            {
                ...
                bondChange:      4_220.758543476229166483 * 1e18,
        ...
        // Residual is not collateralized, auction is active // TODO: is this intended scenario?
        _assertAuction(
            AuctionParams({
                borrower:          _borrower2,
                active:            true,
                kicker:            _lender,
                bondSize:          7_167.643906885874857422 * 1e18,
                bondFactor:        0.3 * 1e18,
                kickTime:          block.timestamp - 43000 seconds,
                kickMomp:          1_505.263728469068226832 * 1e18,
                totalBondEscrowed: 7_167.643906885874857422 * 1e18,
                auctionPrice:      24.443112772227665888 * 1e18,
                debtInAuction:     10_706.023610728654455765 * 1e18,
                thresholdPrice:    25.309748488720223299 * 1e18,
                neutralPrice:      1_597.054445085392479852 * 1e18
            })
        );
        ...
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              10_706.023610728654455765 * 1e18,
                borrowerCollateral:        423.000000000000000000 * 1e18,
                borrowert0Np:              1_575.326150647652569911 * 1e18,
                borrowerCollateralization: 0.384092946216524525 * 1e18
            }
        );
    }
    ...
    function testTakeCallerColConstraintBpfNegResidual () external tearDown {
        ...
        _assertPool(
            PoolParams({
                ...
                lup:                  9.624807173121239337 * 1e18,
                poolSize:             73_118.483609771307158717 * 1e18,
                pledgedCollateral:    992.0 * 1e18,
                encumberedCollateral: 1_977.849865222023998338 * 1e18,
                poolDebt:             19_036.423570145813023131 * 1e18,
                actualUtilization:    0,
                targetUtilization:    1.023051016482943442 * 1e18,
                minDebtAmount:        1_903.642357014581302313 * 1e18,
                loans:                1,
                maxBorrower:          address(_borrower),
                interestRate:         0.045 * 1e18,
                interestRateUpdate:   block.timestamp - 2 hours
        ...
        _assertAuction(
            AuctionParams({
                ...
                active:            true,
                kicker:            _lender,
                bondSize:          82.519509143928899507 * 1e18,
                bondFactor:        0.01 * 1e18,
                kickTime:          block.timestamp - 2 hours,
                kickMomp:          9.818751856078723036 * 1e18,
                totalBondEscrowed: 82.519509143928899507 * 1e18,
                auctionPrice:      157.100029697259568576 * 1e18,
                debtInAuction:     19_016.889091472998029933 * 1e18,
                thresholdPrice:    19.208978880275755585 * 1e18,
                neutralPrice:      10.417497612122395691 * 1e18
            })
        );
        ...
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              19_016.889091472998029933 * 1e18,
                borrowerCollateral:        990.000000000000000000 * 1e18,
                borrowert0Np:              10.275765152019230606 * 1e18,
                borrowerCollateralization: 0.501057720616488588 * 1e18
            }
        );
    }
    ...
    function testTakeLoanDebtConstraintBpfPosResidual() external tearDown {
        ...
        _take(
            {
                ...
                borrower:        _borrower2,
                maxCollateral:   1_001 * 1e18,
                bondChange:      7_315.006141206636337059 * 1e18,
                givenAmount:     24_443.112772227665888000 * 1e18,
        ...
        _assertAuction(
            AuctionParams({
                ...
                active:            true,
                kicker:            _lender,
                bondSize:          10_261.891504616282027998 * 1e18,
                bondFactor:        0.3 * 1e18,
                kickTime:          block.timestamp - 43000 seconds,
                kickMomp:          1_505.263728469068226832 * 1e18,
                totalBondEscrowed: 10_261.891504616282027998 * 1e18,
                auctionPrice:      24.443112772227665888 * 1e18,
                debtInAuction:     3_460.834505806758955692 * 1e18,
                thresholdPrice:    0,
                neutralPrice:      1_597.054445085392479852 * 1e18
            })
        );
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              3_460.834505806758955692 * 1e18,
                borrowerCollateral:        0,
                borrowert0Np:              1_575.326150647652569911 * 1e18,
                borrowerCollateralization: 0
            }
    ...
    function testTakeAndSettle() external tearDown { 
        ...
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              10_704.343890206471287265 * 1e18,
                borrowerCollateral:        0,
                borrowert0Np:              10.307611531622595991 * 1e18,
                borrowerCollateralization: 0
            }
        ...
        _assertAuction(
            AuctionParams({
                ...
                auctionPrice:      10.048254301505840000 * 1e18,
                debtInAuction:     10_704.343890206471287265 * 1e18,
                thresholdPrice:    0,
                neutralPrice:      10.449783245217816340 * 1e18
            })
        );
        ...
        _assertAuction(
            AuctionParams({
                ...
                auctionPrice:      0.613671991004920192 * 1e18,
                debtInAuction:     20_640.392842570100400289 * 1e18,
                thresholdPrice:    21.061625349561326939 * 1e18,
                neutralPrice:      10.449783245217816340 * 1e18
            })
        );
        _assertKicker(
        ...
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              20_640.392842570100400289 * 1e18,
                borrowerCollateral:        980 * 1e18,
                borrowert0Np:              10.307611531622595991 * 1e18,
                borrowerCollateralization: 0.456983115660715402 * 1e18
            }
        );
        ...
        _assertReserveAuction(
            {
                reserves:                   10_823.610749770331320542 * 1e18,
                claimableReserves :         10_720.311109150100290483 * 1e18,
                claimableReservesRemaining: 0,
                auctionPrice:               0,
                timeRemaining:              0
            }
        ...
        _assertAuction(
            AuctionParams({
                ...
                auctionPrice:      0.613671991004920192 * 1e18,
                debtInAuction:     20_045.008276897126830089 * 1e18,
                thresholdPrice:    0,
                neutralPrice:      10.449783245217816340 * 1e18
            })
        );
        ...
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              20_045.008276897126830089 * 1e18,
                borrowerCollateral:        0,
                borrowert0Np:              10.307611531622595991 * 1e18,
                borrowerCollateralization: 0
            }
        ...
        _assertReserveAuction(
            {
                reserves:                   10_823.610749770331320620 * 1e18,
                claimableReserves :         10_723.288031978465158412 * 1e18,
                claimableReservesRemaining: 0,
                auctionPrice:               0,
                timeRemaining:              0
            }
        ...
        _settle(
            {
                ...
                borrower:    _borrower2,
                maxDepth:    10,
                settledDebt: 19_771.275637685539958146 * 1e18
            }
        );
        ...
        _assertBucket(
            {
                ...
                collateral:   0,
                deposit:      8_897.004814975477087961 * 1e18, 
                exchangeRate: 0.808818619543225189814636363 * 1e27
            }
        );
        _assertLenderLpBalance(
            {
        ...
        _settle(
            {
                ...
                borrower:    _borrower2,
                maxDepth:    1,
                settledDebt: 12_764.975862386543877283 * 1e18
            }
        );
        _assertReserveAuction(
             {
                reserves:                   0.815737595499513574 * 1e18,
                claimableReserves :         0,
                claimableReservesRemaining: 0,
                auctionPrice:               0,
                timeRemaining:              0
        ...
        _assertAuction(
            AuctionParams({
                ...
                totalBondEscrowed: 104.670662329841418377 * 1e18,
                auctionPrice:      0.613671991004920192 * 1e18,
                debtInAuction:     7_103.301757555748912039 * 1e18,
                thresholdPrice:    0,
                neutralPrice:      10.449783245217816340  * 1e18
            })
        );
        ...
        _assertBorrower(
            {
                borrower:                  _borrower2,
                borrowerDebt:              7_103.301757555748912039 * 1e18,
                borrowerCollateral:        0,
                borrowert0Np:              10.307611531622595991 * 1e18,
                borrowerCollateralization: 0
            }
        ...
        _settle(
            {
                ...
                borrower:    _borrower2,
                maxDepth:    5,
                settledDebt: 7_006.299775298996080863 * 1e18
            }
        );
        _assertAuction(
            AuctionParams({
