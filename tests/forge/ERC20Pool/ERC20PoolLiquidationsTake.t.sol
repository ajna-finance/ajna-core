    ...
    function testTakeLoanColConstraintBpfPosNoResidual() external tearDown {
        ...
        _assertAuction(
            AuctionParams({
                ...
                referencePrice:    1_597.054445085392479852 * 1e18,
    ...
    function testTakeCallerColConstraintBpfNegResidual () external tearDown {
        ...
        _assertAuction(
            AuctionParams({
                ...
                referencePrice:    10.417497612122395691 * 1e18,
    ...
    function testTakeAndSettle() external tearDown {
        ...
        _assertAuction(
            AuctionParams({
                ...
                bondFactor:        0.01 * 1e18,
                kickTime:          block.timestamp,
                referencePrice:    10.449783245217816340 * 1e18,
        ...
        _assertAuction(
            AuctionParams({
                ...
                referencePrice:    9.818751856078723036 * 1e18,
                totalBondEscrowed: 98.533942419792216457 * 1e18,
    ...
    function testTakeReverts() external tearDown {
        ...
        _assertAuction(
            AuctionParams({
                ...
                bondFactor:        0.01 * 1e18,
                kickTime:          block.timestamp,
                referencePrice:    10.382716182100772629 * 1e18,
