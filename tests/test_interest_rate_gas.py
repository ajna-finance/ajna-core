...
def test_update_interest_rate_gas(
    ...
    with test_utils.GasWatcher(
        ...
        mkr_dai_pool.addQuoteToken(10_000 * 1e18, 1663, {"from": lender})
        mkr_dai_pool.addQuoteToken(10_000 * 1e18, 1637, {"from": lender})
        mkr_dai_pool.addQuoteToken(10_000 * 1e18, 1569, {"from": lender})
