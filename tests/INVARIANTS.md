...
- **A8**: the LUP <= MOMP
- **A9**: bond factor (`Liquidation.bondFactor`) is always bounded by `[1%, 30%]`
...
- **I5**: interest rate (`InterestState.interestRate`) should be bound by min and max rate of 0.1% and 50,000% respectively
