...
library Buckets {
     ...
     *  @return addedLPs_              Amount of bucket LP for the collateral amount added.
     */
    function addCollateral(
        ...
        addLenderLP(bucket_, bankruptcyTime, lender_, addedLPs_);
    }
     ...
     *  @param  lpsAmount_      Amount of LP to be recorded for the given lender.
     */
     ...
     *  @return lps_         Amount of LP calculated for the amount of collateral.
     */
