...
library BucketMath {
    ...
    */
    ...
    function lenderInterestMargin(uint256 mau) public pure returns (uint256) {
    ...
    function auctionPrice(uint256 referencePrice, uint256 kickTime) public view returns (uint256 price_) {
    ...
    function pendingInterestFactor(uint256 elapsed_, uint256 interestRate_) public view returns (uint256) {
