...
contract ERC721ScaledBorrowTest is ERC721HelperContract {
    ...
    function testSubsetPurchaseQuote() external {
        ...
        // check bucket state
        ( , uint256 quote, uint256 collateral, uint256 lpb, , , ) = _subsetPool.bucketInfo(2550);
        assertEq(quote,      0);
        ...
        // check bucket state
        (, quote, collateral, lpb, , , ) = _subsetPool.bucketInfo(testIndex);
    ...
    function testSubsetPurchaseQuoteWithDebt() external {
        ...
        // check bucket state
        ( , uint256 quote, uint256 collateral, uint256 lpb, , , ) = _subsetPool.bucketInfo(2350);
        ...
        // check bucket state
        ( , quote, collateral, lpb, , , ) = _subsetPool.bucketInfo(2350);
        assertEq(quote,      0);
