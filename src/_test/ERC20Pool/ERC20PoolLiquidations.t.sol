    ...
    function testTakeGTNeutral() external {
        ...
        _assertAuction(
            AuctionState({
                ...
                totalBondEscrowed: 0,
                auctionPrice:      0,
                debtInAuction:     19.778659656225180612 * 1e18
            })
        );
    ...
    function testTakeLTNeutral() external {
        ...
        _assertAuction(
            AuctionState({
                ...
                debtInAuction:     9_977.074177773911990381 * 1e18
            })
        );
        _assertKicker(
            {
        ...
        _assertAuction(
            AuctionState({
                ...
                totalBondEscrowed: 0,
                auctionPrice:      0,
                debtInAuction:     601.505181648841377600 * 1e18
            })
        );
        _assertKicker(
            {
        ...
        _assertAuction(
            AuctionState({
                ...
                totalBondEscrowed: 104.609752335437078857 * 1e18,
                auctionPrice:      0.607580991564486240 * 1e18,
                debtInAuction:     9_828.932798221666499549 * 1e18
            })
        );
        _assertKicker(
            {
    ...
    function testHealOnAuctionKicked72HoursAgoAndPartiallyTaken() external {
        ...
        _assertAuction(
            AuctionState({
                ...
                totalBondEscrowed: 0,
                auctionPrice:      0,
                debtInAuction:     481.204145319073102080 * 1e18
            })
        );
        _assertBorrower(
            {
