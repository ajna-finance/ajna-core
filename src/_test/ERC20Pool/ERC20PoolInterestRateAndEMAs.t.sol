...
contract ERC20PoolInterestAccumulationTest is ERC20PoolInterestTest {
    ...
    constructor() {
        ...
        _pool       = ERC20Pool(new ERC20PoolFactory().deployPool(address(_collateral), address(_quote), _initialRate));
    ...
    function testInterestAccumulation() external {
        ...
        _assertPool(
            PoolState({
                ...
                poolDebt:             69.316586538461538494 * 1e18,
        ...
        // Pool wasn't touched, interest grows.
        _assertPool(
            PoolState({
                htp:                  9.634254807692307697 * 1e18,
                lup:                  _p9_91,
        ...
        _assertPool(
            PoolState({
                ...
                loans:                2,
                maxBorrower:          address(_borrower),
                interestRate:         _initialRate - 0.005 * 1e18,
    ...
    function testPoolEMAAndTargetUtilizationUpdate() external {
        ...
        _assertPool(
            PoolState({
                ...
                actualUtilization:    0.050614199200792557 * 1e18,
