...
contract ERC20PoolCollateralTest is DSTestPlus {
    ...
    function testAddRemoveCollateral() external {
        ...
        _borrower.removeCollateral(_pool, 10 * 1e18, address(0), address(0), _r3);
        ...
        _borrower.addCollateral(_pool, 70 * 1e18, address(0), address(0), _r3);
        ...
        _borrower.addCollateral(_pool, 30 * 1e18, address(0), address(0), _r3);
        (, , deposited, borrowerEncumbered, borrowerCollateralization, , ) = _pool.getBorrowerInfo(address(_borrower));
        ...
        skip(46800);
        _borrower.removeCollateral(_pool, 20 * 1e18, address(0), address(0), _r3);
        (, , deposited, borrowerEncumbered, borrowerCollateralization, , ) = _pool.getBorrowerInfo(address(_borrower));
        ...
        _borrower.removeCollateral(_pool, 80 * 1e18, address(0), address(0), _r3);
        assertEq(_pool.getPoolCollateralization(), Maths.WAD);
    ...
    function testClaimCollateral() external {
        ...
        _lender.claimCollateral(_pool, 10_000 * 1e18, 4_000 * 1e18);

        // should revert if no lp tokens in bucket
        vm.expectRevert("P:CC:NO_CLAIM_TO_BUCKET");
        _lender.claimCollateral(_pool, 1 * 1e18, priceHigh);
    ...
    function testLiquidateClaimAllCollateral() public {
        ...
        _lender.claimCollateral(_pool, 0.124956005157448801 * 1e18, _p8002);
        ...
        _lender.claimCollateral(_pool, 0.221718247439898993 * 1e18, _p9020);
        ...
        _lender.claimCollateral(_pool, 1.198023167526491037 * 1e18, _p10016);
