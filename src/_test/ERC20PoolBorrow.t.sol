...
contract ERC20PoolBorrowTest is DSTestPlus {
    ...
    function testBorrowPoolUndercollateralization() external {
        ...
        assertEq(_pool.getPoolAverageDebtAmount(), 100_000.000961538461538462 * 1e18);

        // should revert when taking a loan below 10% of pool average debt amount
    ...
    function testGetHup() external {
        ...
        assertEq(_pool.getPoolAverageDebtAmount(), 50_000.000961538461538462 * 1e18);

        // should revert when deposit lower than 10% of pool average debt amount
