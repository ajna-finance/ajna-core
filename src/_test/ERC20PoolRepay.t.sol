...
contract ERC20PoolRepayTest is DSTestPlus {
    ...
    function testRepay() public {
        ...
        // (1708, 5_007.644384905151472283), (1663, 4_000.927678580567537368), (1606, 3_010.892022197881557845)
        lender.addQuoteToken(pool, 10_000 * 1e18, 1708);
        ...
        emit Repay(address(borrower), 1663, 10_000 * 1e18);
        borrower.repay(pool, 10_000 * 1e18);
