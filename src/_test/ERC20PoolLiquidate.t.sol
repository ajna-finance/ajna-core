...
contract ERC20PoolLiquidateTest is DSTestPlus {
    ...
    function testLiquidate() public {
        ...
        // (1847, 10_016.501589292607751220), (1826, 9_020.461710444470171420) and (924, 100.332368143282009890)
        lender.addQuoteToken(pool, 10_000 * 1e18, 1847);
        lender.addQuoteToken(pool, 1_000 * 1e18, 1826);
        lender.addQuoteToken(pool, 10_000 * 1e18, 924);
    ...
    function testLiquidateScenario1NoTimeWarp() public {
        ...
        // (1847, 10_016.501589292607751220), (1826, 9_020.461710444470171420)
        // (1802, 8_002.824356287850613262) and (924, 100.332368143282009890)
        lender.addQuoteToken(pool, 10_000 * 1e18, 1847);
        lender.addQuoteToken(pool, 1_000 * 1e18, 1826);
        lender.addQuoteToken(pool, 1_000 * 1e18, 1802);
        lender.addQuoteToken(pool, 1_000 * 1e18, 924);
