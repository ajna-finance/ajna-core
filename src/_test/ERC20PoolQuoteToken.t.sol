...
contract ERC20PoolQuoteTokenTest is DSTestPlus {
    ...
    function testDepositQuoteToken() external {
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         40_009_276.785805675373680000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         80_013_709.162620229385860000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         170_340_469.828556676121210000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         370_646_245.224762735012530000 * 1e18);
    ...
    function testDepositQuoteTokenWithReallocation() external {
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         9_012_041.319619176795822000 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       2_400 * 1e18);
        assertEq(_pool.totalQuoteToken(), 600 * 1e18);
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         1_200_132.971304436620365400 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       2_402.302473610465593061 * 1e18);
        assertEq(_pool.totalQuoteToken(), 2_600 * 1e18);
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         6_817_261.014035236782613209 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       2_406.914049681454425699 * 1e18);
        assertEq(_pool.totalQuoteToken(), 5_600 * 1e18);
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         17_430_001.123340971637319850 * 1e18);
    ...
    function testDepositAboveLupWithLiquidityGapBetweenLupAndNextUnutilizedBucket() external {
        ...
        assertEq(_pool.totalQuoteToken(), 3_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         8_409_650.485087153473102000 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       2_100 * 1e18);
        assertEq(_pool.totalQuoteToken(), 900 * 1e18);
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         2_501_961.959549500275849300 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         3_903_088.456474548739948200 * 1e18);
    ...
    function testDepositQuoteTokenAtLup() external {
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         11_315_823.174350100798832000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         5_629_692.752254375388825000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         9_600_058.134266353247365400 * 1e18);
    ...
    function testRemoveQuoteTokenUnpaidLoan() external {
        ...
        assertEq(_pool.totalDebt(),       5_000.028538894209302482 * 1e18);
        assertEq(_pool.totalQuoteToken(), 1_000 * 1e18);
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         4_000_927.678580567537368000 * 1e18);
    ...
    function testRemoveQuoteTokenPaidLoan() public {
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         80_018_553.571611350747360000 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       10_000 * 1e18);
        assertEq(_pool.totalQuoteToken(), 10_000 * 1e18);
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         40_009_276.785805675373680000 * 1e18);
    ...
    function testRemoveQuoteTokenWithDebtReallocation() external {
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         23_840_186.982646726923724200 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         11_837_403.946905024311620200 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         8_430_497.662154068361966000 * 1e18);
    ...
    function testRemoveQuoteTokenOverTimeWithDebt() external {
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         30_068_135.168928991959174000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         15_054_460.110989407789225000 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       4_003.860309036160360017 * 1e18);
        assertEq(_pool.totalQuoteToken(), 1_997.104768222879729987 * 1e18);
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         6_013_066.814135617899598994 * 1e18);
    ...
    function testRemoveQuoteTokenAboveLup() external {
        ...
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         4_500_946.374994395888966200 * 1e18);
        ...
        assertEq(_pool.totalQuoteToken(), 600 * 1e18);
        assertEq(_pool.totalCollateral(), 10 * 1e18);
        assertEq(_pool.pwauSum(),         1_684_696.085462655983506800 * 1e18);
    ...
    function testRemoveQuoteTokenAtLup() public {
        ...
        assertEq(_pool.totalQuoteToken(), 5_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         13_012_484.557300632197040000 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       1_400.000095129380400679 * 1e18);
        assertEq(_pool.totalQuoteToken(), 3_600 * 1e18);
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         7_807_200.069840912036534000 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       1_400.000228310522011229 * 1e18);
        assertEq(_pool.totalQuoteToken(), 3_100 * 1e18);
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         6_301_754.058741971257611500 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       1_400.000361491676291219 * 1e18);
        assertEq(_pool.totalQuoteToken(), 2_599.999923896492059618 * 1e18);
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         5_200_576.056762010169614341 * 1e18);
    ...
    function testRemoveQuoteTokenBelowLup() external {
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         45_060_206.598095883979110000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         33_057_423.562354181367006000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 100 * 1e18);
        assertEq(_pool.pwauSum(),         30_046_531.540156299809161000 * 1e18);
    ...
    function testRemoveQuoteUndercollateralizedPool() external {
        ...
        assertEq(_pool.totalQuoteToken(), 10_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         5_526_610.152862263924920000 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       borrowAmount);
    ...
    function testRemoveQuoteMultipleLenders() external {
        ...
        assertEq(_pool.totalQuoteToken(), 20_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         20_099_793.248583415501880000 * 1e18);
        ...
        assertEq(_pool.totalQuoteToken(), 10_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         10_049_896.624291707750940000 * 1e18);
    ...
    function testRemoveQuoteTokenWithInterest() external {
        ...
        assertEq(_pool.pwauSum(),         100_332.368143282009890000 * 1e18);
        ...
        assertEq(_pool.totalDebt(),       13_000.284586055788614085 * 1e18);
        assertEq(_pool.totalQuoteToken(), 0);
        assertEq(_pool.totalCollateral(), 202 * 1e18);
        assertEq(_pool.pwauSum(),         0);

        assertEq(_pool.getPoolCollateralization(), 1.558976515535795584 * 1e18);
        ...
        assertEq(col, 0);
        assertEq(quoteLPValue, 1_000.023715504649051173 * 1e18);
        ...
        assertEq(poolCollateralizationAfterBorrow, 1.558951902958923946 * 1e18);
        assertGt(actualUtilizationAfterBorrow,     targetUtilizationAfterBorrow);
        ...
        assertEq(_pool.totalDebt(),       1_000.768675660288077071 * 1e18);
        assertEq(_pool.totalQuoteToken(), 12_000 * 1e18);
        assertEq(_pool.totalCollateral(), 202 * 1e18);
        assertEq(_pool.pwauSum(),         107_271_580.039642907181124641 * 1e18);

        assertEq(_pool.getPoolCollateralization(), 2_021.779228553641576224 * 1e18);

        (col, quoteLPValue) = _pool.getLPTokenExchangeValue(
            _pool.lpBalance(address(_lender), _p8002), _p8002
        );
        assertEq(col, 0);
        assertEq(quoteLPValue, 1_000.060953234463672294 * 1e18);
        ...
        vm.expectEmit(true, true, false, true);
        emit Transfer(address(_pool), address(_lender), 1_000.060953234463672294 * 1e18);
        vm.expectEmit(true, true, false, true);
        emit RemoveQuoteToken(address(_lender), _p8002, 1_000.060953234463672294 * 1e18, _p10016);
        ...
        assertEq(_pool.totalDebt(),       1_000.768675660288077071 * 1e18);
        assertEq(_pool.totalQuoteToken(), 10_999.939046765536327706 * 1e18);
        assertEq(_pool.totalCollateral(), 202 * 1e18);
        assertEq(_pool.pwauSum(),         99_268_267.885325696167205095 * 1e18);
    }
    ...
    function testRemoveMoreThanClaim() external {
        ...
        assertEq(_pool.totalQuoteToken(), 4_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         16_003_710.714322270149472000 * 1e18);
        ...
        assertEq(_pool.totalQuoteToken(), 2_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         8_001_855.357161135074736000 * 1e18);
    ...
    function testRemoveQuoteDeactivateBucket() public {
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         150_298_948.393042738130440000 * 1e18);
        ...
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         120_190_028.171063922551990000 * 1e18);
        ...
        assertEq(_pool.totalQuoteToken(), 30_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         100_187_811.982656645545900000 * 1e18);
        ...
        assertEq(_pool.totalQuoteToken(), 20_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         60_178_535.196850970172220000 * 1e18);
        ...
        assertEq(_pool.totalQuoteToken(), 10_000 * 1e18);
        assertEq(_pool.totalCollateral(), 0);
        assertEq(_pool.pwauSum(),         25_035_190.242946951682950000 * 1e18);
