...
interface IPositionManagerOwnerActions {
     ...
     *  @dev    `Pool.increaseLPAllowance` must be called prior to calling this method in order to allow Position manager contract to transfer LPs to be memorialized.
     ...
     *  @dev    `Pool.approveLPTransferors` must be called prior to calling this method in order to allow Position manager contract to transfer redeemed LPs.
